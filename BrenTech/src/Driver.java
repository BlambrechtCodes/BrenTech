/**
 * Class Assign02Test: This class contains test cases for the StarTV, NebulaTV, P8, and P10 classes.
 * It tests various functionalities of these classes, including channel changing, volume adjustment,
 * voice interface commands, picture and video capturing, phone call handling, charging, and type conformance
 * with the TV and Smartphone classes along with the VoiceAssistant and Logger interfaces.
 *
...
public class Driver {
	...
	public static void main(String[] args) {
      ...
      // Creates an instance of StarTV, a TV subclass.
      StarTV starTv = new StarTV();
      
      // Creates an instance of NebulaTV, another TV subclass.
      NebulaTV nebulaTv = new NebulaTV();
      
      // Creates an instance of P8, a specific TV model.
      P8 p8 = new P8();
      
      // Creates an instance of P10, another specific TV model.
      P10 p10 = new P10();
